    ...
    public class KillerDetectionService
    {
        ...
        private void DetectEnvironmentalDeath(Sandbox.Game.Entities.Character.MyCharacter character, KillerInfo info)
        {
            try
            {
                ...
                // Check oxygen
                var oxygenStat = character.StatComp.Stats.GetStat(MyStringHash.GetOrCompute("oxygen"));
                ...
                var healthStat = character.StatComp.Stats.GetStat(MyStringHash.GetOrCompute("health"));
